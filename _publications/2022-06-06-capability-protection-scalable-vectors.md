...
date: 2022-06-06
paperurl: 'https://samuelwstark.com/files/2022-06-06-capability-protection-scalable-vectors.pdf'
citation: 'Stark, Samuel W. (2022). Capability-Based Memory Protection for Scalable Vector Processing. [MPhil thesis]. University of Cambridge.'
...
*Stark, Samuel W. (2022). Capability-Based Memory Protection for Scalable Vector Processing. [MPhil thesis]. University of Cambridge. URL: <https://samuelwstark.com/files/2022-06-06-capability-protection-scalable-vectors.pdf>*
...
@mastersthesis{starkCapabilityProtectionScalableVectors2022,
    ...
    year = "2022",
    month = "June",
    url = "https://samuelwstark.com/files/2022-06-06-capability-protection-scalable-vectors.pdf"
}
```