...
date: 2021-05-01
paperurl: 'https://samuelwstark.com/files/2021-05-fluid-dynamics-opt-viz.pdf'
...
*Stark, Samuel W. (2021). Performance Optimization and Visualization for a Fluid Dynamics Simulation. [Third-year project]. University of Warwick. URL: <https://samuelwstark.com/files/2021-05-fluid-dynamics-opt-viz.pdf>*
...
@unpublished{starkRealTimeFluidSim2021,
    ...
    year = "2021",
    month = "May",
    url = "https://samuelwstark.com/files/2021-05-fluid-dynamics-opt-viz.pdf"
}
```
